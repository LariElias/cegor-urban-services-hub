...
const vistoriaSupervisorSchema = z.object({
...
type VistoriaSupervisorFormData = z.infer<typeof vistoriaSupervisorSchema>;

export default function VistoriaSupervisor() {
  ...
  const [formData, setFormData] = useState<VistoriaSupervisorFormData | null>(null);
  ...
  const {
    ...
    getValues,
    formState: { errors },
  } = useForm<VistoriaSupervisorFormData>({
    resolver: zodResolver(vistoriaSupervisorSchema),
    defaultValues: {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-3xl font-bold">Vistoria Empresa</h1>
      </div>

      <Card>
        <CardHeader className="rounded-t-lg">
          <CardTitle>Vistoria supervisor</CardTitle>
        </CardHeader>
        <CardContent>
